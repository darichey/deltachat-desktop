...
function renderElement(
  ...
  switch (elm.t) {
    ...
    case 'url': {
      ...
      return (
        <Link
          destination={buildLinkDestination(fullUrl, elm.v)}
          key={key}
          tabIndex={tabindexForInteractiveContents}
        />
      )
...
function createMarkdownComponents(
  ...
  return {
    ...
    a: ({ href, children }) => {
      ...
      return (
        <Link
          destination={buildLinkDestination(href || '', linkText || href || '')}
          tabIndex={tabIndex}
        />
      )
    },
...
function MarkdownMessage({
  ...
  const components = createMarkdownComponents(tabIndex, nonInteractiveContent)
  return (
    <Markdown className='markdown-content' components={components}>
      {text}
    </Markdown>
  )
}
