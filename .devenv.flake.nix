{
  ...
  version = "1.11.2";
  system = "x86_64-linux";
  devenv_root = "/home/dev/deltachat-desktop";
  project_input_ref = "path:/home/dev/deltachat-desktop";
  devenv_dotfile = "/home/dev/deltachat-desktop/.devenv";
  devenv_dotfile_path = ./.devenv;
  devenv_tmpdir = "/tmp";
  devenv_runtime = "/tmp/devenv-7f572f1";
  devenv_istesting = false;
  devenv_direnvrc_latest_version = 1;
  container_name = null;
  active_profiles = [
  ];
  hostname = "f52e2626a848";
  username = "dev";
  git_root = "/home/dev/deltachat-desktop";
  secretspec = null;
};
    in
    {
